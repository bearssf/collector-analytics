...
/**
 * Write templates to disk (atomic write via temp file).
 * Persists the validated payload as-is — no re-normalization of percents, slugs, or section shape,
 * so admin saves do not silently rewrite `data/project-templates.json`.
 * @returns {{ ok: true } | { ok: false, error: string }}
 */
