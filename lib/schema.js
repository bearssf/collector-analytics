...
async function ensureCoreSchema(getPool) {
  ...
  const sourceColumns = [
    { name: 'authors',         type: 'NVARCHAR(MAX)',  dflt: null },
    { name: 'publication_date', type: 'NVARCHAR(100)', dflt: null },
    { name: 'article_title',   type: 'NVARCHAR(500)',  dflt: null },
    { name: 'journal_title',   type: 'NVARCHAR(500)',  dflt: null },
    { name: 'volume_number',   type: 'NVARCHAR(50)',   dflt: null },
    { name: 'issue_number',    type: 'NVARCHAR(50)',   dflt: null },
    { name: 'page_numbers',    type: 'NVARCHAR(100)',  dflt: null },
    { name: 'chapter_name',    type: 'NVARCHAR(500)',  dflt: null },
    { name: 'conference_name', type: 'NVARCHAR(500)',  dflt: null },
  ];
